        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="post" action="{{ route('profile_picture.update', $item->id) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        @include('pages.profilepicture.partials.form-control', ['submit' => 'Update'])
                    </form>
                </div>
            </div>
        </div>
