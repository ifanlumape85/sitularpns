...
class UserController extends Controller
{
    ...
    {
        $item = User::findOrFail($id);
        $detail = Detail_user::where('id_user', $id)->first();
        if ($detail != null) {
            $registrasi = Registrasi::where('id_detail_user', $detail->id)->first();
            $persyaratan_user = Persyaratan_user::where()->first('id_registrasi', $registrasi->id)->first();
